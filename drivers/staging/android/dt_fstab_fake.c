...
static char modemblockdevice[50];
DT_PARTITION_INIT(modem, modemblockdevice, "wait", "ro", "vfat")
static char persistblockdevice[50];
DT_PARTITION_INIT(persist, persistblockdevice, "wait", "ro", "ext4")
static char drmblockdevice[50];
DT_PARTITION_INIT(drm, drmblockdevice, "wait", "ro", "ext4")
static char snsblockdevice[50];
DT_PARTITION_INIT(sns, snsblockdevice, "wait", "ro", "ext4")
static char mptblockdevice[50];
DT_PARTITION_INIT(mpt, mptblockdevice, "wait", "ro", "ext4")
